    ...
    <div class="center-box">
        ...
        <div class="card-selection">
            ...
            <div class="selection-card"
                onclick="selectCategory('Internship')">

                <img src="/static/images/internship.png" class="card-image">
            ...
            <div class="selection-card"
                onclick="selectCategory('Job')">

                <img src="/static/images/job.png" class="card-image">

                <div class="card-overlay">

                    <h2>Job Opportunities</h2>

                    <p>Find • Apply • Succeed</p>
...
function selectCategory(category){
    ...
    <div class="center-box">
        ...
        <div class="card-selection">
            ...
            <div class="selection-card"
                onclick="selectSector('IT')">

                <img src="/static/images/it.png" class="card-image">

                <div class="card-overlay">

                    <h2>IT Sector</h2>

                    <p>AI • Cloud • Software • Cyber Security</p>
            ...
            <div class="selection-card"
                onclick="selectSector('Non-IT')">

                <img src="/static/images/non_it.png" class="card-image">

                <div class="card-overlay">

                    <h2>Non-IT Sector</h2>

                    <p>Banking • HR • Marketing • Government</p>
...
function searchInternships(){
    ...
    lastQuery = query;
    lastFilters = filters;
    document.getElementById("loaderSection").scrollIntoView({
        behavior: "smooth",
        block: "start"
    });
